...
class ScanCommand extends Command {
  ...
  ScanCommand() {
    argParser
      ..addOption('path', abbr: 'p', help: 'Root directory to scan', mandatory: true)
...
class RenameCommand extends Command {
  ...
  RenameCommand() {
    argParser
      ..addOption('path', abbr: 'p', help: 'Root directory to process', mandatory: true)
      ..addFlag('dry-run', abbr: 'd', help: 'Preview changes without applying them')
      ..addFlag('interactive', abbr: 'i', help: 'Prompt for confirmation', defaultsTo: true)
      ..addOption('log', abbr: 'l', help: 'Path to undo log file', defaultsTo: 'rename_log.json')
      ..addFlag('verbose', abbr: 'v', help: 'Show detailed output');
  }
  ...
  Future<void> run() async {
    ...
    // If using default log path, place it in the parent directory of the scan path
    ...
    try {
      ...
      try {
        await renamer.processItems(items, dryRun: dryRun, interactive: interactive);
      ...
      logger.info('Processing complete. ${dryRun ? "Use --dry-run=false to apply changes." : ""}');
    } catch (e) {
...
class UndoCommand extends Command {
  ...
  UndoCommand() {
    argParser
      ..addOption('log', abbr: 'l', help: 'Path to undo log file', defaultsTo: 'rename_log.json')
      ..addFlag('preview', abbr: 'p', help: 'Show what will be undone without applying')
      ..addFlag('verbose', abbr: 'v', help: 'Show detailed output');
  }
